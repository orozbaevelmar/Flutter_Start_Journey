...
import 'package:start_journey/cleanArch/core/presentation/widgets/separator.dart';
...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Separator.forColumn(appTheme.scaledSize(5)),
        Icon(
        ...
        Icon(
          Icons.email,
          color: AppColor.blue,
          size: appTheme.scaledSize(20),
        ),
        Separator.forColumn(appTheme.scaledSize(4)),
        Expanded(
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                suffixIconConstraints: BoxConstraints(
                    minWidth: appTheme.scaledSize(48), minHeight: 0),
                ...
                contentPadding: EdgeInsets.symmetric(
                    horizontal: appTheme.scaledSize(16),
                    vertical: appTheme.scaledSize(12)),
                isDense: true,
