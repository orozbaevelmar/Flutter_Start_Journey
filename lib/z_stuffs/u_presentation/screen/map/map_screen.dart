...
import 'package:start_journey/z_stuffs/model/app_lat_long.dart';
import 'package:start_journey/z_stuffs/services/location_service.dart';
            ...
            /*  if (_showCircular)
              Center(
                child: Container(
                  ...
                  child: CircularProgressIndicator(color: MColor.greenPrimary),
                ),
              ), */
            /* Positioned(
              bottom: 200,
